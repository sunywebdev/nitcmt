...
document.getElementById("submit").addEventListener("click", function () {
    ...
    if (rollInput.value == "") {
        resultOutput.innerHTML = `<h3 class="text-danger">Please Enter A Roll Number</h3>`
    } else {
        resultOutput.innerHTML = `<h3 class="text-danger"> Please Enter A Valid Roll Number</h3>`
    }
